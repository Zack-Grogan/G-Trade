...
def test_generate_report_bundle_batches_all_steps(monkeypatch):
    ...
    monkeypatch.setattr(report_service, "get_model_identity", lambda: ModelIdentity(provider="openrouter", model="openai/gpt-5.4-mini"))
    ...
    assert captured["payload"]["model_name"] == "openai/gpt-5.4-mini"
...
def test_compose_report_payload_keeps_model_identity(monkeypatch):
    ...
    assert payload["model_name"] == "openai/gpt-5.4-mini"
