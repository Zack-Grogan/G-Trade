...
2. Identify which task type matches the current request (issue-driven work, local trader/runtime, OpenViking, docs, safety, architecture, exploratory, templates).
