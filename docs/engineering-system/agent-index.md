...
| Issue-driven work (branch, commit, PR) | User has a Linear or other issue; implementing a ticket; creating branch or opening PR | 40-issue-branch-pr-discipline | issue-to-pr | — | direct | linear-workflow.md, github-workflow.md, ../archive/engineering-system-global-cursor-pack/operating-playbooks/starting-work-from-linear-issue.md |
...
| Status / progress / analysis | User asks for project status, progress, or cross-doc synthesis | 02-autonomous-execute-dont-delegate, 03-orchestration-first | — | explore, technical-writer | route-first | cursor-operating-model.md, docs/Current-State.md |
